      ...
      <div className="flex h-screen items-center justify-center bg-[#F8FAFC]">
        <div className="text-center">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-[#1677FF] px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-blue-100 transition-all hover:bg-blue-700"
          >
