...
export default function BranchViewPage() {
  ...
  if (!branch) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#F8FAFC] px-6 py-6 font-sans">
        <div className="text-center rounded-2xl border border-slate-200 bg-white p-10 shadow-sm">
          <h2 className="mb-2 text-xl font-bold text-slate-800">Không tìm thấy dữ liệu</h2>

          <p className="mb-6 text-slate-500">Chi nhánh này không tồn tại hoặc ID không hợp lệ.</p>

          <Link href="/admin/branch">
            <button className="rounded-lg bg-[#1677FF] px-6 py-2.5 font-medium text-white">
              Quay lại danh sách
            </button>
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] px-6 py-6 font-sans">
