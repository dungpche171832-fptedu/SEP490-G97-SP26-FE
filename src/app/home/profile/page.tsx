...
import { MailOutlined, PhoneOutlined, SafetyCertificateOutlined, LockOutlined } from "@ant-design/icons";
        ...
        <div style={{ minHeight: "100vh", background: "#f5f7fb" }}>
            ...
            <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 18px 40px" }}>
                <div style={{ marginBottom: 16 }}>
                    <div style={{ fontSize: 26, fontWeight: 700, color: "#111827" }}>Hồ sơ cá nhân</div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 18 }}>
                        ...
                        <Card style={{ borderRadius: 14 }}>
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                                ...
                                <div style={{ marginTop: 14, fontSize: 18, fontWeight: 700 }}>{fullName || "—"}</div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                            ...
                            >
                                ...
                                <div style={{ marginTop: 10, color: "#9ca3af", fontSize: 12 }}>
                                    * Chức năng cập nhật thông tin đang fix cứng (chưa có API).
                                </div>
                            </Card>
                            ...
                            >
                                <div style={{ maxWidth: 520, display: "flex", flexDirection: "column", gap: 12 }}>
                                    <div>
                                        <div style={{ fontSize: 12, color: "#6b7280", marginBottom: 6 }}>Mật khẩu hiện tại</div>
                                        <Input.Password placeholder="Nhập mật khẩu hiện tại" disabled />
                                    </div>
                                    <div>
                                        <div style={{ fontSize: 12, color: "#6b7280", marginBottom: 6 }}>Mật khẩu mới</div>
                                        <Input.Password placeholder="Nhập mật khẩu mới" disabled />
                                    </div>
                                    <div>
                                        <div style={{ fontSize: 12, color: "#6b7280", marginBottom: 6 }}>Xác nhận mật khẩu mới</div>
